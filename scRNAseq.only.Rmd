...
We download the raw counts of a mouse pancreas data set from  `r BiocPkg("scRNAseq")`. We add normalized logcounts, perform dimension reduction and visualize the embeddings using `r BiocPkg("scater")`. 
